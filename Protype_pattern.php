...
$order3->order_number = 1003;  // Изменяем номер заказа
$order3->products[] = "Product D";  // Добавляем новый товар
...
echo "\nOrder 3:\n";
echo "Order Number: " . $order3->order_number . "\n";
echo "Products: " . implode(", ", $order3->products) . "\n";
echo "Total Price: " . $order3->total_price . "\n";
